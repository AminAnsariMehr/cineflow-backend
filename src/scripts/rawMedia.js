export const rawMedia = [
  ...
  },
  {
    ...
    languages: ["English", "دوبله فارسی"],
    poster: {
      url: "https://images.unsplash.com/photo-1440404653325-ab127d49abc1?w=600",
      horizontal:
  ...
  },
  {
    ...
    ageRating: "PG",
    duration: 125,
    genres: ["Animation", "انیمیشن", "Adventure", "Family", "Fantasy"],
    countries: ["Japan"],
    languages: ["Japanese", "دوبله فارسی"],
    poster: {
  ...
  {
    id: "media_dune_part_3",
    slug: "dune-messiah-2026",
    type: "movie",
    title: {
      en: "Dune: Part Three (Messiah)",
      fa: "تلماسه: بخش سوم",
    },
